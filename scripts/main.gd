...
func _ready() -> void:
	...
	#custom_add_child(SAVE_SYSTEM,false,INTERNAL_F) #<--- Commented out Code (obsolete)
...
func new_game(tutorial:bool) -> void: #TODO setup link to map manager / currently wip
